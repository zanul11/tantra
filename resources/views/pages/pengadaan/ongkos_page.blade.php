<tr id="{{ $id }}">
    <div class="row">
        <td class="with-btn width-200">
            <input class="form-control" type="text" name="ongkos[{{ $id }}][nama]" value="{{ $data? $data['nama']: '' }}" autocomplete="off" required />
        </td>
        ...
        <td class="with-btn width-100">
            <input class="form-control text-right autonumeric-integer" id="total{{ $id }}" type="text" />
        </td>
