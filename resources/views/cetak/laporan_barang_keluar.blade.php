        ...
        <tbody>
            <tr style="height: 146px;">
                <td style="width: 100%; height: 146px;">
                    ...
                    <p style="text-align: center; font-size: 14px;"><strong><u>LAPORAN BARANG KELUAR {{$ket_waktu}}</u></strong></p>
                </td>
            </tr>
                    ...
                    <table style="border-collapse: collapse; width: 100%; font-size:12px;" border="1" padding="15px">
                        <thead>
                            <tr>
                                ...
                                <td align="center" style="padding-left: 3px; padding-top: 3px;padding-bottom: 3px; padding-right: 3px;" rowspan="2"><b>LOKASI</b></td>
